...
class CategoryFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnSubCategory: Button = view.findViewById(R.id.btn_sub_category)
        btnSubCategory.setOnClickListener(this)

    }

    override fun onClick(v: View?) {
        if (v!!.id === R.id.btn_sub_category) {
            val mDetailCategoryFragment = SubCategoryFragment()
            val mBundle = Bundle()
            mBundle.putString(SubCategoryFragment.EXTRA_NAME, "ini dikirim dengan bundle")
            val description = "Ini dikirim dengan getter setter "
            ...
            if (mFragmentManager != null) {
                mFragmentManager
                    ...
                    .replace(
                        ...
                        SubCategoryFragment::class.java.getSimpleName()
                    )
                    .addToBackStack(null)
                    .commit()
            }
